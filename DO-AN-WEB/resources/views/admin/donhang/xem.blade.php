            ...
            <div class="app-content main-content mt-0">
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        @if($donhangId->status == 0)
                        <form action="/admin/donhang/update" method="POST">
                            @csrf
                            <br>

                            <input type="hidden" class="form-control" name="id_don_hang" value="{{$donhangId->id_don_hang}}"/>
                            <button type="submit" class="btn btn-primary">Duyệt đơn hàng</button>
                            <a href="/admin/donhang" type="button" class="btn btn-info">Quay lại</a>
                        </form>
                        @else 
