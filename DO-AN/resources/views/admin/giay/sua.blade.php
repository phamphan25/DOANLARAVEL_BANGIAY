                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                ...
                                <ul class="slide-menu">
                                    ...
                                    <li>
                                        <a href="/admin/giay/giay" class="slide-item">Quản lý sản phẩm</a>
                                    </li>
                                    <li>
                                        <a href="/comment" class="slide-item">Quản lý Bình luận</a>
                                    </li>
                                    <li>
                                        <a href="/contact" class="slide-item">Quản lý shop</a>
                                    </li>
                                    <li>
                                        <a href="/contact/inquiries" class="slide-item">Phản hồi khách hàng</a>
                                    </li>
                                    <li>
                                    ...
                                    <div class="table-responsive">
                                        <form action="/admin/giay/sua" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-outline mb-4">
                                                ...
                                                <input type="input" class="form-control" name="so_luong"
                                                    value="{{$giay['so_luong']}}" required />
                                            </div>
